...
import mapy_cz_geocode.models
from mapy_cz_geocode import rest
from mapy_cz_geocode.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(mapy_cz_geocode.models, klass)
