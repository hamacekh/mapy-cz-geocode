...
class RegionalEntity(BaseModel):
    ...
    iso_code: Optional[StrictStr] = Field(default=None, description="Iso code by ISO 3166-1 alpha-2, only for regional.country", alias="isoCode")
    __properties: ClassVar[List[str]] = ["name", "type", "isoCode"]
