...
class RgeocodeResultEntity(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RgeocodeResultEntity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RgeocodeResultEntity:
        """Create an instance of RgeocodeResultEntity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RgeocodeResultEntity.parse_obj(obj)

        _obj = RgeocodeResultEntity.parse_obj({
            "name": obj.get("name"),
            "label": obj.get("label"),
